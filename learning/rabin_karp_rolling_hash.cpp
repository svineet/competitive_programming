...
int main(int argc, char **argv) {
    RollingHash* h  = new RollingHash("Vineet");
    RollingHash* h2 = new RollingHash("Vineet");
    RollingHash* h3 = new RollingHash("ineeta");

    h->roll_over('a');
    h2->roll_over('a');

    cout << h->get_hash() << endl;
    cout << h2->get_hash() << endl;
